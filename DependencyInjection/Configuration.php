        ...
        $treeBuilder->root('lichess', 'array')
            ...
            ->arrayNode('ai')
                ...
                ->arrayNode('stockfish')
                    ...
                    ->scalarNode('priority')->defaultValue(3)->end()
                    ->scalarNode('executable_path')->defaultValue('/usr/bin/stockfish')->end()
                    ->scalarNode('book_dir')->defaultValue('/usr/share/stockfish')->end()
                ->end()
                ->arrayNode('crafty')
                    ->addDefaultsIfNotSet()
                    ->booleanNode('enabled')->defaultFalse()->end()
